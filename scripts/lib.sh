...
# resolve_effective_auth_mode, resolve_secret_value, load_secret_from_file,
# load_provider_secrets, and preflight_check_provider_auth have moved to
# lib-auth.sh. Callers must source lib-auth.sh explicitly.
