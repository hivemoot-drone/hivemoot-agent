...
# Slot management functions (compute_agent_offset, load_slot_token, load_agent_slots)
# are in lib-slots.sh. Orchestrators must source lib-slots.sh explicitly;
# lib.sh does not source it (flat sourcing model — no lib sources another lib).
