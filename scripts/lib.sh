...
# Validate provider auth configuration. Prints error messages and returns the
# number of validation failures (0 on success). Callers accumulate into their
# own failures counter:
